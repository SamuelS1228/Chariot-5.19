...
def render_sidebar(scn):
    ...
    with st.sidebar:
        ...
        with st.expander('💰 Cost Parameters', expanded=False):
            ...
            _num_input(scn, 'rate_out_mile', 'Outbound', 0.02, '%.4f')
            _num_input(scn, 'in_rate_mile', 'Inbound', 0.01, '%.4f')
            _num_input(scn, 'trans_rate_mile', 'Transfer (RDC ➜ WH)', 0.015, '%.4f')
        ...
        if st.session_state.get('run_target') == name:
            with st.spinner('Running optimization…'):
                ...
                res = optimize(
                    ...
                    inbound_rate_mile=scn['in_rate_mile'],
                    ...
                    transfer_rate_mile=scn['trans_rate_mile'],
